...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 text-sm text-neutral-800 leading-relaxed">
      ...
      <p className="mt-2">
        회원 탈퇴 시 모든 개인정보와 프로젝트 데이터는 즉시 영구 삭제됩니다. 앱 내 "계정 삭제"
      ...
      <p className="mt-2">
        이용자는 언제든지 본인의 개인정보를 열람, 수정, 삭제할 수 있으며, "계정 삭제"를
